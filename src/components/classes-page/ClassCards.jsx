      ...
      <div className="container grid gap-10 lg:grid-cols-2 3xl:grid-cols-3">
        ...
        <div className="clip-path-hexagon-fix group relative">
          ...
          >
            ...
            The Town <span/> Finest Body Fitness Authoritatively distribute multimedia that is based on
        ...
        <div className="clip-path-hexagon-fix group relative">
          ...
          >
            ...
            <p className="font-medium text-gray-300 transition-all group-hover:text-white">
            The City <span/> Finest Body Fitness Authoritatively distribute multimedia that is based on
        ...
        <div className="clip-path-hexagon-fix group relative">
          ...
          >
            ...
            <p className="font-medium text-gray-300 transition-all group-hover:text-white">
            The Finest Physical Fitness Facility in the Area Distribute multimedia content in an authoritative manner.
        ...
        <div className="clip-path-hexagon-fix group relative">
          ...
          >
            ...
            <p className="font-medium text-gray-300 transition-all group-hover:text-white">
            The Best Body Fitness in the city Authoritatively disseminate
              multimedia based
            </p>
          </div>
        </div>
